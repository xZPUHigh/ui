...
function Library:GetColor(color, table)
    ...
    if (color.R == nil) then return Color3.fromRGB(110, 0, 253) end
...
function Library:CreateWindow(title, color)
    title = title or "ZPU HUB : Pet Simulator 99"
    color = color and Library:GetColor(color) or Color3.fromRGB(110, 0, 253)
